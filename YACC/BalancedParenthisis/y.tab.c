...
const int YY_parse_CLASS::Lpar=258;
const int YY_parse_CLASS::Rpar=259;
...
static const char * const yytname[] = {   "$","error","$illegal.","Lpar","Rpar",
"NL","stmt","S",""
};
#endif
