...
const int YY_parse_CLASS::UND=260;
...
static const char * const yytname[] = {   "$","error","$illegal.","NUMBER","LETTER",
"UND","NL","valid","variable","alphanumeric",""
};
#endif
...
static const short yypact[] = {     4,
     2,     2,    -5,     2,     2,     2,-32768,-32768,-32768,-32768,
-32768,-32768,    10,    11,-32768
};
